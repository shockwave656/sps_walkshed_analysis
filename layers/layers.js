...
lyr_POIsAccessiblebyNormativePedestrianWalksheds_5.set('fieldImages', {'name': 'TextEdit', 'category': 'TextEdit', 'osm_key': 'TextEdit', 'osm_value': 'TextEdit', 'source': 'TextEdit', 'confidence': 'TextEdit', 'node_id': 'TextEdit', 'overture_confidence': 'TextEdit', });
lyr_POIsAccessiblebyTypicalPedestrianWalksheds_6.set('fieldImages', {'name': 'TextEdit', 'category': 'TextEdit', 'osm_key': 'TextEdit', 'osm_value': 'TextEdit', 'source': 'TextEdit', 'confidence': 'TextEdit', 'node_id': 'TextEdit', 'overture_confidence': 'TextEdit', });
lyr_POIsAccessiblebyRollingandManualWheelchairWalksheds_7.set('fieldImages', {'name': 'TextEdit', 'category': 'TextEdit', 'osm_key': 'TextEdit', 'osm_value': 'TextEdit', 'source': 'TextEdit', 'confidence': 'TextEdit', 'node_id': 'TextEdit', 'overture_confidence': 'TextEdit', });
...
lyr_AllPOIs_4.set('fieldLabels', {'name': 'inline label - visible with data', 'category': 'no label', });
lyr_POIsAccessiblebyNormativePedestrianWalksheds_5.set('fieldLabels', {'name': 'no label', 'category': 'no label', 'osm_key': 'no label', 'osm_value': 'no label', 'source': 'no label', 'confidence': 'no label', 'node_id': 'no label', 'overture_confidence': 'no label', });
lyr_POIsAccessiblebyTypicalPedestrianWalksheds_6.set('fieldLabels', {'name': 'no label', 'category': 'no label', 'osm_key': 'no label', 'osm_value': 'no label', 'source': 'no label', 'confidence': 'no label', 'node_id': 'no label', 'overture_confidence': 'no label', });
lyr_POIsAccessiblebyRollingandManualWheelchairWalksheds_7.set('fieldLabels', {'name': 'no label', 'category': 'no label', 'osm_key': 'no label', 'osm_value': 'no label', 'source': 'no label', 'confidence': 'no label', 'node_id': 'no label', 'overture_confidence': 'no label', });
lyr_SeattlePublicSchools_8.set('fieldLabels', {'school_name': 'inline label - visible with data', 'status': 'no label', 'grades': 'no label', 'address': 'no label', });
