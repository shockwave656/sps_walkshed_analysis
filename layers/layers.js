...
lyr_POIsAccessiblebyNormativePedestrianWalksheds_6.set('fieldImages', {'name': 'TextEdit', 'category': 'TextEdit', 'osm_key': 'Hidden', 'osm_value': 'Hidden', 'source': 'Hidden', 'confidence': 'Hidden', 'node_id': 'Hidden', 'overture_confidence': 'Hidden', });
lyr_POIsAccessiblebyTypicalPedestrianWalksheds_7.set('fieldImages', {'name': 'TextEdit', 'category': 'TextEdit', 'osm_key': 'Hidden', 'osm_value': 'Hidden', 'source': 'Hidden', 'confidence': 'Hidden', 'node_id': 'Hidden', 'overture_confidence': 'Hidden', });
lyr_POIsAccessiblebyRollingandManualWheelchairWalksheds_8.set('fieldImages', {'name': 'TextEdit', 'category': 'TextEdit', 'osm_key': 'Hidden', 'osm_value': 'Hidden', 'source': 'Hidden', 'confidence': 'Hidden', 'node_id': 'Hidden', 'overture_confidence': 'Hidden', });
...
lyr_AllPOIs_5.set('fieldLabels', {'name': 'inline label - visible with data', 'category': 'inline label - visible with data', });
lyr_POIsAccessiblebyNormativePedestrianWalksheds_6.set('fieldLabels', {'name': 'inline label - visible with data', 'category': 'inline label - visible with data', });
lyr_POIsAccessiblebyTypicalPedestrianWalksheds_7.set('fieldLabels', {'name': 'inline label - visible with data', 'category': 'inline label - visible with data', });
lyr_POIsAccessiblebyRollingandManualWheelchairWalksheds_8.set('fieldLabels', {'name': 'inline label - visible with data', 'category': 'inline label - visible with data', });
lyr_SeattlePublicSchools_9.set('fieldLabels', {'school_name': 'inline label - always visible', 'status': 'inline label - visible with data', 'grades': 'inline label - visible with data', 'address': 'inline label - visible with data', });
